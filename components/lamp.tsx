...
export const LampContainer = ({
	...
	return (
		<div
			className={cn(
				"relative flex h-full flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
				className
			)}
		>
			<div className="absolute top-36 z-50  flex w-full flex-1 scale-y-125 items-center justify-center isolate ">
				<motion.div
